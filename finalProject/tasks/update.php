...
if(isset($_POST['submit'])){
    ...
    $sql="update `tasks` set id=$id,title='$title',description='$description',due_date='$due_date',completed='$completed'
    where id=$id";
    $result=mysqli_query($con,$sql); 
    if($result){
    ...
    <body>
        ...
        <form method="post">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" placeholder="Enter your completed" name="completed" autocomplete="off"
